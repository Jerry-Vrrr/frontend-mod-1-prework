...
if (dogAge <= 2) {
  ...
  console.log("Bet you're glad those crate training days are over!");
} else if (dogAge >= 10) {
  console.log("So distinguished, that one!");
} else  {
  console.log("...That's a cat, silly!");
}
...
Did yours? Yes!! Do you know what a logical operator in JavaScript is? Google it to answer
for yourself!
