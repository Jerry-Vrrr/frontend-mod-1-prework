...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//It was pretty intuitive that name would be a string, numberOfPets would be a number
//and is hungry is a true/false question and therefore would be a boolean.
...
console.log(numberOfPets);
  ...
  // NOTE:// values (but same data type).
// log all three variables to the console.
